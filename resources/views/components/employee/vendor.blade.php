<div class="vander_dataview">
    <ul>
       ...
       <li>
        ...
        <li>
            <strong>Contact From: </strong> 
            <p>{{ Helper::date($data->contact_from,'d m Y') }}</p>
        </li>
        <li>
            <strong>Contact TO: </strong> 
            <p>{{ Helper::date($data->contact_to,'d m Y') }}</p>
        </li>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            @if($data->service)
                ...
                @php $item=json_decode($data->service); @endphp
                    @forelse($item as $itemKey => $itemVal)
                        <div class="col-md-3">
                            {{ \App\Models\Vendor::services($itemVal) }}
                        </div>
                    @empty
                    <p> Not found </p>
                    @endforelse
