        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="{{ route('user.certificates') }}">Certificate</a> <span class="bread-slash">/</span>
                                    </li>
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('user.saveCertificate') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('certificate_heading', \App\Models\Certificate::certificateHeadings(), [], ['class'=>'form-control', 'id'=>'certificate_heading', 'placeholder'=>'Choose Certificate Heading', 'required'=>true])}}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="logo1_file">Logo1 File</label>
                                        {{ Form::file('logo1_file',['class'=>'form-control','id'=>'logo1_file','placeholder'=>'Upload Logo1 File'])}}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="logo2_file">Logo2 File</label>
                                        {{ Form::file('logo2_file',['class'=>'form-control','id'=>'logo2_file','placeholder'=>'Upload Logo2 File', 'required' => true])}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="data-custon-pick" id="issuedDate">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="issued_on" class="form-control" id="" placeholder="Issued On" value="{{ old('issued_on') ?? '' }}" required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('certificate_validity', \App\Models\Certificate::certificateValidities(), [], ['class'=>'form-control', 'id'=>'certificate_validity', 'placeholder'=>'Choose Certificate Validity', 'required'=>true])}}
                                        <span class="text-danger">{{ $errors->first('certificate_validity') }}</span>
                                    </div>
                                </div>
                                @php
                                    if(old('certificate_validity') == 1) {
                                        $cssv = 'display:block';
                                    } else {
                                        $cssv = 'display:none';
                                    }
                                ...
                                <div class="col-md-4" id="validity_sec" style="{{ $cssv }}">
                                    <div class="form-group">
                                        ...
                                        <div class="data-custon-pick" id="validityDate">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" name="validity_date" class="form-control validity_date" id="validity_date" placeholder="Validity Date" value="{{ old('validity_date') ?? '' }}">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12  vander_dataview">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('name[0]', '', ['class'=>'form-control', 'placeholder'=>'Name'])}}
                                                    <span class="text-danger">{{ $errors->first('name.0') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('designation[0]', '', ['class'=>'form-control', 'placeholder'=>'Designation'])}}
                                                    <span class="text-danger">{{ $errors->first('designation.0') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group"> 
                                                    {{ Form::text('company[0]', '', ['class'=>'form-control', 'placeholder'=>'Company'])}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('name[1]', '', ['class'=>'form-control', 'placeholder'=>'Name'])}}
                                                    <span class="text-danger">{{ $errors->first('name.1') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('designation[1]', '', ['class'=>'form-control', 'placeholder'=>'Designation'])}}
                                                    <span class="text-danger">{{ $errors->first('designation.1') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group"> 
                                                    {{ Form::text('company[1]', '', ['class'=>'form-control', 'placeholder'=>'Company'])}}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('name[2]', '', ['class'=>'form-control', 'placeholder'=>'Name'])}}
                                                    <span class="text-danger">{{ $errors->first('name.2') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    {{ Form::text('designation[2]', '', ['class'=>'form-control', 'placeholder'=>'Designation'])}}
                                                    <span class="text-danger">{{ $errors->first('designation.2') }}</span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group"> 
                                                    {{ Form::text('company[2]', '', ['class'=>'form-control', 'placeholder'=>'Company'])}}
                            ...
                            <div class="row">
                                            ...
                                            @forelse(\App\Models\Certificate::hardCopy() as $key => $val)
                                               <div class="col-md-2">
                                                    <div class="i-checks pull-left">
                                                        <label>
                                                            <input type="radio" value="{{$key}}" class="hard_copy" name="hard_copy" > <i></i> {{$val}}
                                                        </label>
                                                    </div>
                                                </div>
                                            @empty
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="data-custon-pick" id="neededDate">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" name="needed_by" class="form-control" id="" placeholder="Needed by" value="{{ old('needed_by') ?? '' }}" required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('vendor',$vendors,[],['class'=>'form-control','id'=>'vendor','placeholder'=>'Choose Printing Vendor','required'=>true])}}
                        ...
                        <div class="form_section vendorDetail" style="{{ $css }}">
                            @if(old('vendor'))
                                @php 
                                    $data = \App\Models\Vendor::where('slug',old('vendor'))->first();
                                @endphp
                                @if($data)
                        ...
                        <div class="form_section">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        {{ Form::textarea('additional_information','',['class'=>'form-control','id'=>'additional_information','placeholder'=>'Additional information'])}}
