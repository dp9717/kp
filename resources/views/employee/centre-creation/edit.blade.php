    ...
    <div class="main-content">
        <div class="container-fluid"> 
            <div class="row">
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('user.updateCentreCreation',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    @forelse($data->file as $fkey => $val)
                                        <div class="col-md-2 mb-2">
                                            <div class="attc_imgs savedimg_box">
                                                    ...
                                                    <a href="{{route('user.fileRemoveCentreCreation',[$val->id,$data->slug])}}" title="{{ $val->file_path }}">
