                                           ...
                                           @forelse($data as $result)
                                                <tr>
                                                  ...
                                                  <td class="">
                                                    ...
                                                    {!! Html::decode(link_to_route('user.restoreCentreCreation','<i class="fa fa fa-history restore"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-info restore','title'=>'Restore'])) !!}

                                                    {!! Html::decode(link_to_route('user.hardDltCentreCreation','<i class="fa fa-trash"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-danger hardDlt','title'=>'Permanent Remove','onclick'=>'return removeData()'])) !!}
