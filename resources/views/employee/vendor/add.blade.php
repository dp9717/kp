        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('user.saveVendor') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf

                        <div class="form_section">
                            <div class="row">
                                <div class="col-md-12"> <h1>Vendor</h1></div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="data-custon-pick" id="syncDate">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" name="contact_from" class="form-control" id="" placeholder="Contact From">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="data-custon-pick" id="syncDate2">
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="contact_to" class="form-control" id="" placeholder="Contact To">
                                        </div>
                                    </div>
                                ...
                                @forelse(\App\Models\Vendor::services() as $key => $val)
                                   <div class="col-md-3">
                                        <div class="i-checks pull-left">
                                            <label>
                                                <input type="checkbox" value="{{$key}}" class="service" name="service[]" > <i></i> {{$val}}
                                            </label>
                                        </div>
                                    </div>
