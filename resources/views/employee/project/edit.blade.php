    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('user.updateProject',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="data-custon-pick" id="syncDate">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="start_date" class="form-control" id="" placeholder="Start Date" value="{{ $data->mou_start_date ?? ''}}">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4" style="">
                                    <div class="form-group">
                                        ...
                                        <div class="data-custon-pick" id="syncDate2">
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                <input type="text" name="end_date" class="form-control" id="" placeholder="End Date" value="{{ $data->mou_end_date ?? ''}}">
                                            </div>
                                        </div>
                                            ...
                                            @forelse($data->file as $fkey => $val)
                                                <div class="col-md-2 mb-2">
                                                    <div class="attc_imgs savedimg_box">
                                                            ...
                                                            <a href="{{route('user.fileRemoveProject',[$val->id,$data->slug])}}" title="{{ $val->file_path }}">
