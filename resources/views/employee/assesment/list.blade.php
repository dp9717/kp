                            ...
                            <div class="col-md-3">
                               ...
                               <div class="button-style-four btn-mg-b-10">
                                    @if(\App\Models\ProcessAppFlow::permission(9,1))
                                        <a class="btn btn-custon-four btn-default text-success add" href="{{ route('user.addAssesment') }}" title="Add"><i class="fa fa-plus"></i></a>
                                    @endif
                                </div>
                                    ...
                                    <tr>
                                      ...
                                      <td class="">
                                        ...
                                        @if(\App\Models\ProcessAppFlow::permission(9,count(\App\Models\Assesment::status())))
                                            {!! Html::decode(link_to_route('user.editAssesment','<i class="fa fa-edit"></i>',[ $result->slug ],['class'=>'btn btn-custon-four btn-default text-info edit','title'=>'Edit'])) !!}
                                        @endif
                                      </td>
                                    </tr>
                                   @empty
