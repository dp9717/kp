                ...
                <div class="breadcome-list">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           <h1>Trashed modules : {{ $total }} </h1>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                <li><a href="{{ route('admin.home') }}">Home</a> <span class="bread-slash">/</span>
                                </li>
                                 <li><a href="{{ route('admin.modules') }}">Module List</a> <span class="bread-slash">/</span>
                                </li>
                                <li><span class="bread-blod">Trashed Modules</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row yemm_serachbox">
                                                <div class="col-sm-12 col-md-10 main_serach">
                                                ...
                                                <div class="col-sm-12 col-md-2 exportSec">
                                                    <div class="form-group">
                                        ...
                                        <tbody>
                                           @forelse($data as $result)
                                                <tr>
                                                  ...
                                                  <td>
                                                     {{ \App\Models\Module::status($result->status) }}
                                                  </td>
                                                  <td class="">
                                                    ...
                                                    {!! Html::decode(link_to_route('admin.restoreModule','<i class="fa fa fa-history restore"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-info restore','title'=>'Restore'])) !!}

                                                    {!! Html::decode(link_to_route('admin.hardDltModule','<i class="fa fa-trash"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-danger hardDlt','title'=>'Permanent Remove','onclick'=>'return removeData()'])) !!}
