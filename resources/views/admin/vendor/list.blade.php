                        ...
                        <div class="row">
                            <div class="col-md-3">
                               ...
                               <div class="button-style-four btn-mg-b-10">
                                    <a class="btn btn-custon-four btn-default text-success hardDltBtn" href="{{ route('admin.trashedVendor') }}" title="Restore"><i class="fa fa-trash"></i></a>
                                </div>
                                    ...
                                    <tr>
                                      ...
                                      <td class="">
                                        ...
                                        @endphp
                                            ...
                                            {!! Html::decode(link_to_route('admin.editVendor','<i class="fa fa-edit"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-info edit','title'=>'Edit'])) !!}

                                            {!! Html::decode(link_to_route('admin.removeVendor','<i class="fa fa-trash"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-danger remove','title'=>'Remove','onclick'=>'return removeData()'])) !!}
                                        

                                        @if($result->status < count(\App\Models\Vendor::status()))
                                            {!! Html::decode(link_to_route('admin.vendorStatusView','<i class="fa fa-check"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-success Approve','title'=>'Approve'])) !!}
                                        @endif
                                      </td>
                                    </tr>
                                   @empty
