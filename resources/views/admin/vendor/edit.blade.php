    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="{{ route('admin.vendors') }}">Vendor</a> <span class="bread-slash">/</span>
                                    </li>
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('admin.updateVendor',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
                        <div class="form_section">
                            <div class="row">
                                <div class="col-md-12"> <h1>Vendor Information</h1></div>
                               <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="contact_from">Contact From</label>
                                    <div class="data-custon-pick" id="syncDate">
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="contact_from" class="form-control" id="" placeholder="Contact From" value="{{Helper::date($data->contact_from,'d-m-Y')}}">
                                        </div>
                                    </div>
                                    <span class="text-danger">{{ $errors->first('contact_from') }}</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="contact_to">Contact To</label>
                                    <div class="data-custon-pick" id="syncDate2">
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="contact_to" class="form-control" id="" placeholder="Contact To" value="{{Helper::date($data->contact_to,'d-m-Y')}}">
                                        </div>
                                    </div>
                                    <span class="text-danger">{{ $errors->first('contact_to') }}</span>
                                </div>
                            </div>
                                            ...
                                            @forelse($data->file as $fkey => $val)
                                                <div class="col-md-2 mb-2">
                                                    <div class="attc_imgs savedimg_box">
                                                            ...
                                                            <a href="{{route('admin.fileRemoveVendor',[$val->id,$data->slug])}}" title="{{ $val->file_path }}">
                        ...
                        <div class="form_section">
                            ...
                            <div class="row">
                                @forelse(\App\Models\Vendor::services() as $key => $val)
                                   <div class="col-md-3">
                                        <div class="i-checks pull-left">
                                            <label>
                                                <input type="checkbox" value="{{$key}}" class="service" name="service[]" @if(in_array($key,(($data->service) ? json_decode($data->service) : []))) checked @endif> <i></i> {{$val}}
                                            </label>
                                        </div>
                                    </div>
