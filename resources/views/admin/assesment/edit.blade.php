    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><a href="{{ route('admin.assesments') }}">Assesment</a> <span class="bread-slash">/</span>
                                    </li>
                ...
                <!-- pro -->
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('admin.updateAssesment',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                        @csrf
