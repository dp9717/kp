            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form_section popupdata">
                    <div class="row">
                        ...
                        <x-employee.centre-creation :$data/>
                    </div>
                </div>

                <form method="post" action="{{ route('admin.centreCreationStatusApprove',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                    @csrf
