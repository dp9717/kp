                        ...
                        <div class="row">
                            <div class="col-md-3">
                               ...
                               <div class="button-style-four btn-mg-b-10">
                                    <a class="btn btn-custon-four btn-default text-success hardDltBtn" href="{{ route('admin.trashedProject') }}" title="Restore"><i class="fa fa-trash"></i></a>
                                </div>
                               ...
                               @forelse($data as $result)
                                    <tr>
                                      ...
                                      <td class="">
                                        ...
                                        @if($result->status < count(\App\Models\Project::status()))
                                            {!! Html::decode(link_to_route('admin.projectStatusView','<i class="fa fa-check"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-success Approve','title'=>'Approve'])) !!}
                                        @endif
                                      </td>
                                    </tr>
                                   @empty
