        ...
        <div class="breadcome-list">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <h1>Total Trashed Project : {{ $total }} </h1>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <ul class="breadcome-menu">
                        ...
                        <li><span class="bread-blod">Trashed Project List</span>
                        </li>
                    </ul>
                </div>
            </div>
                                           ...
                                           @forelse($data as $result)
                                                <tr>
                                                  ...
                                                  <td class="">
                                                    ...
                                                    {!! Html::decode(link_to_route('admin.restoreProject','<i class="fa fa fa-history restore"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-info restore','title'=>'Restore'])) !!}

                                                    {!! Html::decode(link_to_route('admin.hardDltProject','<i class="fa fa-trash"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-danger hardDlt','title'=>'Permanent Remove','onclick'=>'return removeData()'])) !!}
