        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form_section popupdata">
                    <div class="row">
                        <div class="col-md-12"> <h1>Project Information</h1></div>  
                        <x-employee.project :$data/>
                    </div>
                </div>

                <form method="post" action="{{ route('admin.projectStatusApprove',$data->slug) }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                    @csrf
