                ...
                <div class="breadcome-list">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           <h1>Trashed users : {{ $total }} </h1>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu">
                                <li><a href="{{ route('admin.home') }}">Home</a> <span class="bread-slash">/</span>
                                </li>
                                 <li><a href="{{ route('admin.users') }}">User List</a> <span class="bread-slash">/</span>
                                </li>
                                <li><span class="bread-blod">Trashed Users</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                           @forelse($data as $result)
                                                <tr>
                                                  ...
                                                  <td>
                                                     {{ \App\Models\User::status($result->status) }}
                                                  </td>
                                                  <td class="">
                                                    ...
                                                    {!! Html::decode(link_to_route('admin.restoreUser','<i class="fa fa fa-history restore"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-info restore','title'=>'Restore'])) !!}

                                                    {!! Html::decode(link_to_route('admin.hardDltUser','<i class="fa fa-trash"></i>',[$result->slug],['class'=>'btn btn-custon-four btn-default text-danger hardDlt','title'=>'Permanent Remove','onclick'=>'return removeData()'])) !!}
