...
class AdminCertificateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.certificate.list',compact('data','search','page','total','batch','batches', 'students','student'));
    ...
    public function edit($slug)
    {
        ...
        if($data){
            ...
            return view('admin.certificate.edit',['batch'=>$batch, 'vendors' => $vendors, 'data'=>$data]);
        }else{
    ...
    public function update(CertificateRequest $request,$slug=null)
    {
        ...
        if($data){
            ...
            if($data->save()) {
                ...
                return to_route('admin.certificates')->with('success', 'Saved successfully !');
            }else{
                return back()->with('failed', 'Wrong access or try again.');
            }
